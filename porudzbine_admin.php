...
<head>
	...
	<link href="porudzbine_admin.css" rel="stylesheet">
    <style>
        .row_selected td {
...
<div class="container marketing">
    ...
    $porudzbine = $porudzbina->dajPorudzbine('');
    ?>
    ...
    <table class="tabela2 display" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr id="<?php echo $row->id;?>">
                                ...
                                <td>
                                <a href="obrisiPorudzbinu.php?id=<?php echo $row->id; ?>" class="btn btn-danger">OBRIŠI</a>
                                </td>
                            </tr>
                            <?php
                                    }
